...
| `layoutAdapter`                     | `LayoutAdapter \| new (service) => LayoutAdapter \| Partial<LayoutAdapter>` | BaseWebAdapter | Constructor, full adapter instance, or partial object merged onto the built-in web adapter. See [Layout adapter](#layout-adapter) below.                                                                    |
